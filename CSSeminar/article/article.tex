...
\title{Cool, Chill, and Cruel: Probabilistic Ranking with Greedy Approach for Recovering Sparse Binary Secrets in LWE}
\author{MAMANCHUK Mykola, SID.202420671 \\ Supervising Professor: KUNIHIRO Noboru \\ \small{University of Tsukuba / CRISEC}}
\date{\today}
...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.65\linewidth]{example_variance_plot.png} 
...
\[
  =\; 2^{\,n_{\mathrm{cruel}}} 
     \;+\; 
     \underbrace{\binom{n_{\mathrm{chill}}}{k_{\mathrm{chill}}} 
       \times \mathrm{ML\_overhead}(1) 
       \times
       \bigl[ 1 + \mathrm{liability\_coef}\times(\dots) \bigr]}_{\text{chill enumerations}} 
     \;+\;
